...
const sciAlerts = [
  {
    ...
    description: '2 AG à programmer dans les 30 jours',
    icon: AlertCircle,
    type: 'warning'
  },
  {
    title: 'Déclarations fiscales',
    description: '1 déclaration à effectuer avant le 15/03',
    icon: AlertCircle,
    type: 'error'
  }
];
...
const recentActivity = [
  {
    title: 'Nouvelle SCI',
    description: 'SCI Les Oliviers créée',
  ...
  },
  {
    ...
    description: 'Jean Dupont ajouté à SCI Bellevue',
  ...
  {
    title: 'AG terminée',
    description: 'PV signé - SCI Les Roses',
...
const quickActions = [
  {
    title: 'Créer une SCI',
    description: 'Enregistrer une nouvelle société',
    icon: Building2,
    color: 'emerald'
  },
  {
    title: 'Ajouter un associé',
    description: 'Gérer les parts sociales',
    icon: UserPlus,
    color: 'blue'
  },
  {
    title: 'Gérer les documents',
    description: 'Accéder aux statuts et PV',
    icon: FileText,
    color: 'purple'
  }
];
      ...
      <div className="flex items-center justify-between p-4 border-b dark:border-gray-700">
        <div className="flex-1 max-w-xl">
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Rechercher une SCI..."
      ...
      <div className="max-w-7xl mx-auto p-8">
        ...
        >
          ...
          <p className="text-gray-600 dark:text-gray-300">
            Gérez vos sociétés civiles immobilières et leurs associés
          </p>
        </motion.div>
